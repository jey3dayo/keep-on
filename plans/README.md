...
| 007  | habit mutation の dateKey/TZ/archived ゲート強化                                  | P1       | M      | —          | TODO   |
| 008  | オフライン enqueue の userId 欠落時 reject                                        | P1       | S      | —          | TODO   |
| 009  | docs ドリフト修正と @typescript/native 削除                                       | P1       | S      | —          | TODO   |
| 010  | calendar query の userId スコープ化                                               | P1       | S      | —          | TODO   |
