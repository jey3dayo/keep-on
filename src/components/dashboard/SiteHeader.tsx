...
export function SiteHeader() {
  ...
  return (
    <header className="flex h-[--header-height] shrink-0 items-center gap-2 border-border/50 border-b bg-background/50 backdrop-blur-xl transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-[--header-height] supports-[backdrop-filter]:bg-background/30 md:rounded-t-xl">
